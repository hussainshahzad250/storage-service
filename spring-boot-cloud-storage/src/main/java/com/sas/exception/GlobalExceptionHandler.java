...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleUnknownHostException(UnknownHostException ex) {
        log.error("UnknownHostException occurs =>", ex);
        return new ResponseEntity<>(new Response("Please try after sometime!", HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex) {
        ...
        return new ResponseEntity<>(new Response("Incorrect Request body supplied", HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        return new ResponseEntity<>(new Response("Please pass mandatory Attributes " + fieldsValidated, errors, HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
}